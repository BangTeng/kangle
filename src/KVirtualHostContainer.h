...
public:
	...
	//old interface
	bool bindVirtualHost(KSubVirtualHost *svh,kgl_bind_level high);
	query_vh_result findVirtualHost(KSubVirtualHost **rq_svh,domain_t hostname);
	kgl_del_result unbindVirtualHost(KSubVirtualHost *svh);
	void addVirtualHost(KVirtualHost *vh,kgl_bind_level high);
